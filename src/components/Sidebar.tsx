...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  const tabs = ['Spreadsheet', 'Chat', 'Workflows', 'Settings'];

  return (
    <aside className="w-64 bg-white p-4 shadow-md rounded-r-lg flex flex-col">
      <nav className="space-y-2">
        {tabs.map((tab) => (
          <button
            ...
            className={`
              w-full flex items-center p-3 rounded-md text-left text-sm font-medium
              ${activeTab === tab
